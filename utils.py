...
class DashRouter:
    ...
    def __init__(self, app, urls):
        ...
        urls:  Ordered iterable of routes: tuples of (route, layout). 'route'
            is a string corresponding to the URL path of the route (will be
            prefixed with Dash's 'routes_pathname_prefix' and 'layout' is a
            Dash Component or callable that returns a Dash Component. The
            callable will also have any URL query parameters passed in as
            keyword arguments.
            """
...
class DashNavBar:
    ...
    def __init__(self, app, nav_items):
        ...
        nav_items:  Ordered iterable of navbar items: tuples of
            ...
            'routes_pathname_prefix') and 'display' is a valid value for
            the `children` keyword argument for a Dash component
