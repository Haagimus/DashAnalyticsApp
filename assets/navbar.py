    ...
    if data['logged_in']:
        if data['isadmin']:
            if data['login_user'] == site_admin:
                lbl = '{} (Site Admin)'.format(data['login_user'])
    ...
    layout = html.Nav([
        dbc.Nav([
            dbc.NavItem(dbc.NavLink(html.Img(id='logo', src='..\\assets\images\L3Harris.svg'),
                                    ...
                                    style={'padding': '0px'})),
            dbc.NavItem(dbc.NavLink('Home', id='home-link', href='/', external_link=True)),
            dbc.NavItem(dbc.NavLink('Employees', id='employees-link', href='/employees', external_link=True)),
            dbc.NavItem(dbc.NavLink('Programs', id='programs-link', href='/programs', external_link=True)),
            dbc.NavItem(dbc.NavLink('Capacity', id='capacity-link', href='/capacity', external_link=True)),
            dbc.NavItem([
                dbc.Button('Register',
                           id='registerOpen',
                           n_clicks=0,
